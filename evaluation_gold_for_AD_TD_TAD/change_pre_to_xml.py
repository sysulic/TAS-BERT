...
gold_path = '../data/semeval2015/three_joint/TO'
file_gold = 'test_NLI_B'
pre_path = '../results/semeval2015/three_joint/TO/word_24batch'
file_pre = 'test_ep_21'
file_xml = 'ABSA15_Restaurants_Test.xml' # gold xml file -> used to get the file structure
