...
"""CUDA_VISIBLE_DEVICES=0 python ABSA_joint.py"""
from __future__ import absolute_import, division, print_function

"""
use for:
    1. three joint task (target & category & polarity) -> use the three_joint folder as input
    2. target & polarity joint task -> use the target_polarity folder as input
    3. target & category joint task -> use the target_category folder as input
