...
path = 'results/semeval2015/loss_split/TO'
folder_AS = 'LPM_TO_AS'
folder_T = 'LPM_TO_T'
best_ep_AS = 0
best_F_AS = 0
...
for index in range(1, epochs+1):
	...
	with open(os.path.join(path, folder_AS, TXT_file(file_pre)), 'r', encoding='utf-8') as f_pre:
		print(file_pre)
		f_pre.readline()
...
for index in range(1, epochs+1):
	file_pre = 'test_ep_' + str(index)
	with open(os.path.join(path, folder_T, TXT_file(file_pre)), 'r', encoding='utf-8') as f_pre:
		print(file_pre)
		f_pre.readline()
...
with open(os.path.join(path, folder_AS, TXT_file(best_ep_AS)), 'r', encoding='utf-8') as f_AS, open(os.path.join(path, folder_T, TXT_file(best_ep_T)), 'r', encoding='utf-8') as f_T:
	Gold_Num = 0
	True_Num = 0
	Pre_Num = 0
	NULL_Gold_Num = 0
